		...
		<div class="container">
			<div class="row">
				<div class="col-lg-3 col-md-6">
					<h3>About Us</h3>
					<p>The project is yet to be completed</p>
				</div>
				<div class="col-lg-3 col-md-6">
					<h3>UseFull Links</h3>
				...
				<div class="col-lg-3 col-md-6">
					...
					<p class="lead">Bengaluru - CMRIT
AECS LAYOUT, Brookfield
Pin-560037</p>
					<p class="lead"><a href="#">+91 6364182870</a></p>
					<p><a href="#"> abba23cs@cmrit.ac.in</a></p>
				</div>
				<div class="col-lg-3 col-md-6">
					<h3>Opening hours</h3>
