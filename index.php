		...
		<ul class="slides-container">
			<li class="text-left">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20"><strong>Welcome To <br> Maher Lunch Restaurant</strong></h1>
			...
			<li class="text-left">
				<img src="images/1-Lunch-restaurants-1-ki1aq.jpg" alt="">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20"><strong>We like  <br> to eat well.</strong></h1>
							<p class="m-b-40">Maher Lunch Restaurant is serving a Authentic Lunch Food.And Restaurant's 
<br> 
			...
			<li class="text-left">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20"><strong>Welcome To <br> CMR Restaurant</strong></h1>
			...
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-12 text-center">
					<div class="inner-column">
						<h1>Welcome To <span>Maher Lunch Restaurant</span></h1>
						<h4>Little Story</h4>
						<p>Restaurants in Bangalore, Bangalore Restaurants, CMRIT restaurants, Best CMRIT restaurants, West Bangalore restaurants, Snacks Restaurants in Bangalore, Snacks near me, Snacks Restaurants in West Bangalore, 
Snacks Restaurants in CMRIT, 
 </p>
						<p>Quick Bites in Bangalore, Quick Bites near me, Quick Bites in West Bangalore, Quick Bites in CMRIT, in Bangalore, near me, in West Bangalore, in CMRIT, in Bangalore, near me, in West Bangalore, in CMRIT, New Year Parties in Bangalore, Christmas' Special in Bangalore,</p>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 ml-auto mr-auto text-center">
					...
					<span class="lead">CMR Restaurant</span>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<div class="heading-title text-center">
						<h2>Gallery</h2>
						<p>Delicious food Pictures for CMR Restaurant Listed Here </p>
					</div>
				</div>
			</div>
					...
					<div id="reviews" class="carousel slide" data-ride="carousel">
						...
						<?php } ?>
							<div class="carousel-item text-center active">
								...
								<h5 class="mt-4 mb-0"><strong class="text-warning text-uppercase">Aayush</strong></h5>
